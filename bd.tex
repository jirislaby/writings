...
bug-reports for the Linux kernel, to support another software project, and to
...
\section{Current Contents of the Database}\label{sec:data}
...
according to methodologies of~\cite{CHK09,HW08} which produce several metrics
...
All authors have been supported by The Czech Science Foundation (GA\v{C}R),
grant No.~P202/12/G061.
