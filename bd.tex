...
kernel 2.6.28 by the following tools: \clang 3\footnote{We used modified
  \texttt{experimental.unix.PthreadLock} checker, where support for kernel
  locking was added.}, \stanse, and one tool which wanted to stay in
anonymity. We also included bug reports from kernel and Novell bug tracking
systems and mailing lists using our own web crawler.

The database comprises 616 reports of 11 types: 118 real errors, 388 false
positives, and 110 entries which were left unclassified. Many of the
unclasified entries were added even recently and are about to be classified
soon. The following table depicts how each kind of bugs is represented in
the database.
...
bug reports, or another comments, please contact us
