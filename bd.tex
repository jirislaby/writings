...
from our benchmark suite and run the tool on these source codes.
%Let us note that \cdb contains only open-source projects.
As the second step, the
sub-database of classified bug-reports corresponding to the chosen project
is downloaded from \cdb.
% Note that
The installation and local database usage is
...
Finally, user is kindly asked to insert newly discovered bug-reports with
