...
\section{Current Data and Their Sources [J]}\label{sec:data}
In the end the database comprises 498 reports in 11 categories.
118 of the reports are real, 353 false positives. The database contains also
