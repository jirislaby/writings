...
\end{description}
Except they are in the database and can be accessed in raw, they can be also
viewed using the web interface as is shown in Fig.~\ref{fig:error}.
...
Here, we list all error types currently available in \cdb. This can be also
seen in Fig.~\ref{fig:types}. Along with all the types we also attach a
description of the actual error location here. It may be sometimes unclear
what code line is connected to a particular error type.
