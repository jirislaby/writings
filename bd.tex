...
The error location is the line of the request.
\end{description}
...
error occurrence in Table~\ref{tab:stats}. We can see that the highest ratio
of errors per file is in the architectural code (x86 in our case).

What is not in the Table, but can be read out of \cdb is that maximum false
positives per file (19) is found in the very core of a kernel scheduler in
\texttt{kernel/sched.c}. It is followed by the XFS filesystem in
