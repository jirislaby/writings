...
We plan to extend the database in several ways. We will extend the data if
we find another source of bug reports. Further, we may extend the number of
considered kinds of errors. Finally, we think about building similar
datbases also for newer versions of the Linux kernel or for other real-life
projects. The future of our database depends also on a feedback of the
