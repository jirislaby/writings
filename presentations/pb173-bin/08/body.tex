...
%      \item V jednom z dalších cvičení
	...
	\item Relativně drahá operace
      ...
      \item Uvidíme \iffimuni dnes\fi dále
    \end{itemize}
...
\begin{frame}
  ...
  \begin{enumerate}
    ...
    \item Zavolejte z funkce \code{c_start}
    \begin{itemize}
      \item \code{fork}
    ...
    \begin{itemize}
      \item Pomocí \cmd{make} (pouižije \cmd{gcc -nostdlib ...})
    \end{itemize}
  \end{enumerate}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item Formát zásobníku od jádra je pevně daný
    \end{itemize}
  \end{itemize}
...
\begin{frame}
  \frametitle{Formát zásobníku od jádra}
  ...
  \begin{center}
    \begin{tabular}{|l|l|} \hline
      ...
      Konec parametrů & \code{NULL}   \\ \hline\hline

      1.\ proměnná prostředí     & \code{char *} \\ \hline
      \dots                      & \code{char *} \\ \hline
      n-tá proměnná prostředí    & \code{char *} \\ \hline
      Konec proměnných prostředí & \code{NULL}   \\ \hline\hline
      ...
      Konec rozšiřujících vektorů & \code{struct \{ AT_NULL, ? \}} \\ \hline
...
\begin{frame}
  ...
  \begin{enumerate}
    \item Vytvořte si nový zdrojový soubor a překládejte standardně
