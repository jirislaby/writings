...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item Implicitně jménem tokenu/pravidla \tikz[remember picture] \node [coordinate] (IMPL) {};
...
helloWorld : x=AHOJ y=SVETE {
  ...
  \begin{tikzpicture}[remember picture,overlay]
    \path<3->[arr] (IMPL) edge[out=355,in=100] (IMPLT);
