...
\begin{frame}{Statická vs.\ dynamická alokace}
  ...
  \begin{itemize}
    ...
    \item Specialitou je \emph{alokace polí} s proměnnou délkou (od C99)
    \begin{itemize}
...
\begin{frame}[fragile]{Alokace dynamické paměti}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item Návratová hodnota: \code{NULL} při chybě, jinak adresa

      \pause

      \item Jeden souvislý blok
      \item Na haldě
      \item Paměť není inicializována, obsahuje ,,smetí''
    \end{itemize}
...
\begin{frame}[fragile]{Uvolnění dynamické paměti}
...
\begin{frame}{Úkol}
  ...
  \begin{enumerate}
    ...
    \item Čekejte na vstup od uživatele
    \begin{itemize}
      \item \code{getchar()}
    \end{itemize}
...
\begin{frame}[fragile]{Změna dynamické paměti}
