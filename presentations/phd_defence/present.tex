...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Summer School in Software Engineering and Verification 
    \item Invited talks: 3
...
\begin{frame}
  ...
  \begin{textblock*}{0.54\textwidth}(0.23\textwidth,1cm)
  \includegraphics[width=\textwidth]{principles_of_mc}
  \end{textblock*}

  \begin{textblock*}{12cm}(0.3cm,1.1cm)
  \only<2>{
  \colorbox[rgb]{0.972 0.925 0.76}{\includegraphics[width=\textwidth,clip,trim=2.65cm 17.85cm 4.9cm 1.1cm]{principles_of_mc_1}}}
  \end{textblock*}
