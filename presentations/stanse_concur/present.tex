...
\begin{frame}
  ...
  \begin{itemize}
  \item Lepši znalost o ukazatelích v programu pro přesnější analýzu
...
\begin{frame}
  ...
  \begin{center}
  \begin{tabular}{ccc|c}
    \includegraphics[height=4.4cm]{RAG1} &
    \includegraphics[height=4.4cm]{RAG2} &
    \includegraphics[height=4.4cm]{RAG3} &
    \includegraphics[height=4.4cm]{RAG}
  \end{tabular}
  \end{center}
\end{frame}
...
/* no unlock */
  ...
  & \textcolor{red}{Potenciální chyba} \\ \hline
  \end{tabular}
  \end{center}
...
void fun(int error)
{
  ...
  \parbox[c]{6cm}{\includegraphics[height=6cm]{dead}}
  \end{tabular}
  \end{center}
...
\begin{frame}
  ...
  \begin{itemize}
  \item Checkery načítají XML soubory s konfigurací
  \item AutomatonChecker -- popis automatu
