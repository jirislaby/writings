...
\begin{frame}
  ...
  \begin{enumerate}
    ...
    \begin{itemize}
      \item Open a release s nějakým \code{pr_info} a \code{return}
...
\begin{frame}[fragile]{Vytvoření znakového zařízení}
...
% TODO rozdelit na 3 slidy a predelat
...
\begin{frame}
  ...
  \item \code{write} vypíše uživatelský buffer pomocí \code{pr_info}
  \begin{itemize}
...
\begin{frame}[fragile]{Datové typy}
...
\begin{frame}[fragile]{Pevné typy v jádře}{z hlediska počtu bitů}
