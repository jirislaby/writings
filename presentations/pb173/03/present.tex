...
\begin{frame}
  ...
  Nastavení konzole v \texttt{/proc/sys/kernel/printk}
  \begin{itemize}
  \item Popis: \doc{Documentation/sysctl/kernel.txt}
  \item 4 čísla:
    \begin{enumerate}
    \item Zprávy s vyšší úrovní se objeví na konzoli (\texttt{dmesg -n})
  ...
  Pozn. 1: nastavení syslogu je závislé na systému

  Pozn. 2: \texttt{dmesg} nastavit nelze
