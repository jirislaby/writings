...
\begin{center}
  ...
  \begin{tikzpicture}[node distance=3mm, font=\footnotesize]
      ...
      \node [minimum width=2.5cm] (EX) [above=0mm of USERAEX]
        {\textbf{Example}};
...
\begin{center}
  ...
  \begin{tikzpicture}[node distance=3mm, font=\footnotesize]
      ...
      \node [sized] (USERSPACE) [left=of APP] {Userspace};
      \node [sized] (KERNELSPACE) [left=of PROTO] {Kernelspace};

      \begin{pgfonlayer}{background}
	\node [tl_statenet,fit=(APP)] {};
	\node [tl_statenet,fit=(SYSCALL)(PAI)(PROTO)(DAI)(DD)] {};
      \end{pgfonlayer}
