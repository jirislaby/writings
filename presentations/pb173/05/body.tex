...
\begin{frame}
  ...
  \begin{enumerate}
    ...
    \item Vypište virtuální adresu (\code{\%p} a porovnat hodnotu s fyzickou)
    \item Vypište signaturu (4\,B textu -- \code{virt[0]})
    \item Vypište délku tabulky (4\,B -- \code{virt[1]})
