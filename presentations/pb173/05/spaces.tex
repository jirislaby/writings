...
\begin{tikzpicture}
  ...
  \begin{pgfonlayer}{ram}
    \node [box,fill=blue!15,spcwid,minimum height=1.2cm,below=-\pgflinewidth of US.south,baseline=-5ex] (PHYS2) {};
  ...
  \node [box,above left=-\pgflinewidth and 0pt of KERN.north east] {Hole};
