...
\begin{frame}
  ...
  \item Jeden si zvolit (\emph{jinou než} \code{RSDP})
  \item Zapamatovat si adresu (\code{0x00000000af5b0100})
  \end{itemize}
  \item Získat virtuální adresu (\code{u32 *virt = ioremap_cache(phys, 8)})
  \item Vypsat virtuální adresu (\code{\%p} a porovnat hodnotu s fyzickou)
  \item Vypsat signaturu (4\,B textu -- \code{virt[0]})
  \item Vypsat délku tabulky (4\,B -- \code{virt[1]})
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Podrobnosti viz wiki nebo Překladače
  \end{itemize}
