...
\begin{frame}[fragile]{Jednoduchá komunikace}

  \heading{2 procesy (producent--konzument)}
  \begin{itemize}
...
\begin{frame}
  ...
  \begin{enumerate}
    \item Do \file{pb173/07/events} doplňte \code{completion}
...
\begin{frame}
  ...
  \begin{enumerate}
    \item V \file{pb173/07/events} použijte namísto \code{completion}
      \code{wait_queue}
    \item Číst se bude, až bude v bufferu zapsáno alespoň 5 znaků
    \item Vyzkoušejte zápisem např.\ 2 a 8 znaků
  \end{enumerate}
...
\begin{frame}[fragile]{\code{kthread}}
...
\begin{frame}
  ...
  \begin{enumerate}
    ...
    \item Opakujte v cyklu dokud někdo neodebere modul
