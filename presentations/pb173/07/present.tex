...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item Zvýšit: \code{pci_dev_get}
      \item Snížit: \code{pci_dev_put}
...
\begin{frame}
  ...
  \begin{enumerate}
    ...
    \item Vložit a odebrat modul (a zkontrolovat \cmd{dmesg})
  \end{enumerate}
...
\section{Zobecnění na jiné sběrnice}
\frame{\sectionpage}
