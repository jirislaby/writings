...
\begin{frame}
  ...
  \texttt{cp -\,-sparse=always /home/shared/slaby/centos.img
    /home/local/centos-xlogin.img}
  ...
  \begin{itemize}
  \item Může chtít nastavit jméno+e-mail (instrukce na stdout)
  \end{itemize}
...
\begin{frame}
  ...
  \begin{enumerate}
  \item Spustťe \textsc{Qemu} (\texttt{qemu-start})
  ...
  \item \texttt{git push} (poslat na aisu)
  \end{enumerate}
\end{frame}
