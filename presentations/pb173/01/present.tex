...
\begin{frame}
  ...
  {\footnotesize\texttt{cp -\,-sparse=always /home/shared/slaby/centos.img
  /home/local/}}
  ...
  \begin{enumerate}
  \item Na aise ve svém \textasciitilde\ proveďte klon
  \begin{itemize}
...
\begin{frame}
  ...
  \begin{enumerate}
  \item Spusťte \textsc{Qemu} (\texttt{./qemu-start /home/local/centos.img})
  \item \texttt{git clone git+ssh://xlogin@aisa.fi.muni.cz/home/xlogin/pb173}
  ...
  \item \texttt{git commit -a}
  \item Pošlete na aisu (\texttt{git push})
  \end{enumerate}
\end{frame}
...
\begin{frame}
  ...
  \item Jako obvykle \texttt{commit+push}
  \end{enumerate}
\end{frame}
