...
We have manually analysed all the found errors and classify them as real errors
or false positives (with an exception of 60 errors found by \AC where we
...
to all classified errors can be also found in
Table~\ref{tab:results}. The overall ratio of real errors to all classified
...
illustration, see \url{http://lkml.org/lkml/2009/3/11/380}).
