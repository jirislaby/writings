...
\end{tabular}
\end{center}
\caption{Evaluation results on the Linux kernel 2.6.28. Not all
of the error reports (column {\bf Reports}) were classified to real errors
(column {\bf Bugs}) and false positives (column {\bf FP}). {\bf \% FP}
represents percentage of false positives in all classified reports.
