...
(including 696 superfluous semicolons) and they are ommitted from our
statistics.

\begin{table}[b]
\begin{center}
\begin{tabular}{|l|l|c|c|c|c|} \hline
\textbf{checker} & \textbf{property} & \textbf{reported err.} & \textbf{bugs} & \textbf{false pos.} & \textbf{ratio} \\ \hline\hline
\textit{Automaton} & \textit{Pairing}
                             & 266 & 65  & 143 & 31.3\,\% \\ \hline
& \textit{Memory}            & 86  & 48  & 37  & 56.5\,\% \\ \hline
& \textit{Atomic}            & 35  & 16  & 18  & 47.1\,\% \\ \hline
\textit{Thread}        & n/a & 20  & 9   & 11  & 45.0\,\% \\ \hline
\textit{Reachability}  & n/a & 31  & 31  & 0   & 100.0\,\%  \\ \hline\hline
\textbf{Overall}       &     & 438 & 169 & 209 & 44.7\,\% \\ \hline
\end{tabular}
\end{center}
...
We have manually analyzed all the reported errors and mark them as real bugs
...
Table~\ref{tab:results}. The overall ration of real bugs to all classified
...
In the subsequent versions of the kernel, we have reported another 50 bugs
found by \Stanse and this number is increasing every month.
