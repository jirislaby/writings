...
should be improved.\todo{tu prvni vetu jeste predelat - chvalu do prvniho
  odstavce, tady nechat jen future work.} For example, we are currently
working on C++ support (note that the framework can handle any programming
language for which a frontend is written).\todo{Lepe prodat?} Further, we
plan to provide \Stanse in the form of a plug-in for Eclipse or NetBeans
IDE. A lot of work can be done in the area of automatic false-alarm
filtering and error importance classification.
