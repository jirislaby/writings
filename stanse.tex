...
\begin{figure}[t]
  \centering
    \includegraphics[width=9cm]{fig_bug-tracing}
...
license.Currently, the tool is used mainly by the developers and students at the
Masaryk University. It is also used by programmers in a partner software company,
and a handful of Linux kernel developers. Several other kernel developers,
in whose code \Stanse has found bugs, have also expressed interest in using
\Stanse regularly\footnote{\url{http://lkml.org/lkml/2009/7/18/59} and
follow-ups}. We therefore expect the number of users to go
significantly up with the first full release 1.0.0.
