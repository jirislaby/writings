...
writing appropriate parsers. Finally, \Stanse is basically a Java library,
so it can be easily transformed into a static analysis plug-in for Eclipse
or NetBeans IDE.
...
%
We note that more than 130 bugs found by \Stanse have already been reported
to and accepted by Linux kernel developers.
