...
\begin{abstract}
  ...
  extendibility with new bug-finding techniques with a minimal effort.
...
Here we present our results of evaluation \Stanse's checker \AC just on version 2.6.28. We focused at checking of
...
\item atomic section restrictions to find whether someone can cause deadlocks by
...
executions. The false positives rate oscillates among different properties, but the
overall ratio is that 40\,\% of all reported errors are real bugs.  Bugs were
reported to kernel developers and fixed in the following kernel releases. Some of
...
\textbf{Automaton} & \textbf{Reports} & \textbf{Bugs} & \textbf{FP} & \textbf{\% FP} \\ \hline\hline
\textit{Pairing} & 266 &  65  & 143 & 68.8\,\% \\ \hline
\textit{Memory}  & 86  & 48  & 37  & 43.5\,\% \\ \hline
\textit{Atomic}  & 35  &  16  & 18  & 52.9\,\% \\ \hline\hline
\textbf{Overall} & 387 & 129 & 198 & 60.6\,\% \\ \hline
\end{tabular}
\end{center}
\caption{\AC evaluation results on version 2.6.28 of Linux kernel. Not all of the error
reports (column {\bf Reports}) were sorted to real error (column {\bf Bugs})
or false positives (column {\bf FP}). Column {\bf \% FP} represent percentage ofe
...
% \begin{itemize}
% \item pro� je pou�it p��tomn� pr�b�hov� �as v prvn� v�te sekce 4? 
% \item ve druh�m odstavci se p��e, �e k�d kernelu je specifick�, co� by m�lo
%   b�t zohledn�no v toolu a v odstavci na to se p��e, �e na�e checkery jsou
%   nez�visl� na konkr�tn�m k�du.
% \item ve t�et�m odstavci se p��e, �e pouze AutomatonChecker se mus�
%   konfigurovat. Bohu�el, ThreadChecker vy�aduje konfiguraci t��. 
% \item v 5. odstavci: z ��sla 70 a z tabulky 1 nen� jasn�, pro� jsme pouze 70
%   ze 129 chyb reportovali v�voj���m. 
% \item v 5. odstavci: ...we believe it is due... Nen� d�le�it� �emu
%   v���me. Tu v�tu bych tam ned�val.
% \item odstavec 6 a Figure 2 bych zcela vypustil. Je to nepodstatn�. 
% \item v tabulce 1 bych sloupec Errors nahradil za Reports, a d�le bych zcela
%   vypustil sloupec Assorted - d� se lehce dopo��tat, sta�� se v popisu
%   tabulky zm�nit. 
% \item posledn� odstavec ne��k� ��dnou d�le�itou informace o Stanse - zcela
%   bych jej vypustil.
% \end{itemize}
