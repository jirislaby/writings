...
\textbf{Checker} & \textbf{Property} & \textbf{Reports} & \textbf{Bugs} & \textbf{FP} & \textbf{\% FP} \\ \hline\hline
\textit{Automaton} & & & & & \\ \hline
...
\textbf{Overall} does not include \textit{Reachability} results.}
\label{tab:results}
\end{table}
