...
během svých Ph.D.\ studií. Snažíme se také uvést autorův podíl v~procentech.
...
oponentským procesem. Tři z konferencí/workshopů jsou v~ERA označkování jako
\emph{A}, \emph{B} a \emph{C}. Další dvě publikace autora, na nichž není tato
práce postavena, byly publikovány na konferencích označkováných \emph{A}.
Navíc, jedna z nich byla prezentována také autorem této práce. Autor byl také
\emph{pozván} a ochotně pozvání přijal, aby hovořil o práci z
publikace~\ref{pub_stanse} na konferenci ,,embedded world conference 2010''.
Autor byl také pozván, aby hovořil o vývoji Linuxového jádra na workshopu NFX,
který byl spoluorganizován Univerzitou Tomáše Bati ve Zlíně.
