...
project. Unfortunately, this is not true in the real world.  The tools are
often incomplete in some sense. First, they often cannot even read source
codes of such large project. This problem stems from the languages projects
are written in.  Even though there are standards for languages, there are many
