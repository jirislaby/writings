...
previous research, did an \emph{expert interview}\footnote{The survey was
performed in the scope of a Bachelor thesis named "Augmented reality in the
context of the evolution of the information society" by J.
Ryb\'{a}\v{r}ov\'{a}. The thesis is in Czech, hence we repeat the information
here.} among academic people involved in organizing academic events like
conferences. Analytical sample consists of 14 academicians -- 1 professor, 4
associative professors, 4 assistant professors and 5 post-docs.  The research
showed that there was a lack of proper tool corresponding to the state of the
Internet development (Web 2.0). This was one of the main reasons for creating
\tp, because competitive products tend to be very user-unfriendly with many
illogical workflows in their control. Their \emph{Graphical User Interface}
(GUI) matches with the 1990s' state of graphical design.

With the results of the survey we were able reflect not only our own
experiences from organizing (some members of development team have held
conferences since 1993) in the \tp functionality definition, but also
\emph{wishes and requirements of its potential users}.

Another issue of contemporary academic events is their preservation in time.
Many web presentations of two or more years old conferences, seminars or alike
cannot be found on the Internet because organizers have just deleted them. The
level of graphical design of those web presentations is very similar to GUI of
the systems they empower them -- they do not reflect trends in 2010s', i.e.
they don't reflect user orientation, usability, accessibility and latest
psychologist (PCA) results. In contrast, \tp offers a template made by
...
on the basis of expert requirements for the particular tool to facilitate
