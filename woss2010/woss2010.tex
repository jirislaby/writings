...
involved in organizing academic events like conferences. Analytical sample
consists of 14 academicians -- 1 professor, 4 associative professors, 4
...
(Web 2.0). This was one of the main reasons for creating \tp, because
competitive products tend to be very user-unfriendly with many illogical
workflows in their control. Their \emph{Graphical User Interface} (GUI)
matches with the 1990s' state of graphical design.
