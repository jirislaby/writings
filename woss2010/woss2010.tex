...
them\footnote{There are examples known to us like SOFSEM 2009.}. The graphic
design of the webs seems to be outdated as well in comparison to the modern
web applications such as Flickr, Facebook or Google facilities. The organizers
seem not to adapt their webs to the trends in 2010s'. Particularly, they don't
reflect user orientation, usability, accessibility and latest psychologist
(PCA) results. In contrast, \tp tries to preserve the conference data as long
as possible (possibly infinitely). It also offers conference templates made by
professional graphic designers from the beginning.
...
localization and may be deployed anywhere. On the other hand, it is aimed
solely at scientific conferences and has limited functionality in comparison
to \tp. \textsc{EasyChair}\footnote{\url{http://www.easychair.org/}} allows
for parallel conference, creation of proceedings for papers typeset with a
special template, but XXX
